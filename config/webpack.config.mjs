...
function getWebpackConfig(webpackArgs) {
    return {
        ...
        optimization: {
            ...
            usedExports: true, // Safe tree-shaking of unused exports based on Terser's ability to parse exported functions and their usage. True by default in 'production' mode.
            minimizer: [
                new TerserJSPlugin(),
            ...
            splitChunks: {
                chunks: 'all',
                // maxSize: 700000,  // Max file size of any chunk unless overridden below -- NOTE: Test multiple values since sometimes this can bloat the output file sizes
                cacheGroups: {
                    /*
                    ...
                    styles: {  // Management of splitting of stylesheets
                        test: Styles,
